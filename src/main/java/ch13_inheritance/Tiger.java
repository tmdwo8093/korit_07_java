...
public class Tiger extends Animal{ // 자식 클래스 extends 부모클래스
    ...
    public void hunt(String prey) {
        System.out.println(getAnimalName() + "가 " + prey + "를 사냥 합니다.");
    }

    // 재정이된 methods : 부모 메서드의 결과값과 다르게 작성한다면 전부 재정의에 해당함
    @Override   // 얘가 붙어있으면 해당 매서드는 상속 받은 것
