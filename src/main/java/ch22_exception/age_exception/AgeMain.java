...
//        int age = scanner.nextInt();    // 전에는 여기에 바로 작성해서 넣었는데,
        ...
        // 예외가 발생할 가능성이 있는 부분을 try문 안에 넣어주는것이 중요합니다
        try {
        ...
        } catch (InputMismatchException e) {        // Scanner 사용했ㅁ는데 변수의 자료형과 일치하지 않을 때 적용됨 "스무살", 38.7이 동일한 예외 발생
        ...
        /*
            이상의 코드에서 정상적인 데이터 한 번 / 비정상적인 데이터를 한 번 실행시켜봤을 떄의
