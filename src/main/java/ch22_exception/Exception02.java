...
//            System.out.println("ID 혹은 비밀번호를 확인하세요.");
    ...
    public static void main(String[] args) {
        ...
        //
//        login(inputId, inputPassword);  // 코드 작성 순서 잘 기억하시면 좋겠스빈다
        // throws 키워드를 달게 되니깐 여기에 오류가 발생했습니다.

        try {
            login(inputId, inputPassword);
        } catch (LoginFailedException e) {  // 자동완성으로 사용시 정의 Exception 클래스가 나왔는데
...
/*
    ...
    mehod의 정의 / 생성자 정의 /  객체 생성 방식이라는 저희가 여태까지
    배워온 코드 작성 방법과 차이가 없다는 것을 확일할 수 있습니다.
 */
