...
public class StrSet {
    public static void main(String[] args) {
        ...
        // 뒤에 "언어" 라고 붙여서 java 언어, 와 같이 데이터를 조작하는것이
        // 불가능하다는것을 알 수 있습니다.
        // 이상의 문제 등을 이유로 set -> list로의 변환 역시 자주 쓰입니다.
        List<String> modfiedStrList = new ArrayList<>();
        modfiedStrList.addAll(strSet);
        // 새로운 List에 대입하는 과정입니다.
        System.out.println(modfiedStrList);
        // set의 순서와 동일하게 들어갔기 때문에 마찬가지로 순서가 보장되지 않습니다.
        Collections.sort(modfiedStrList);
        System.out.println(modfiedStrList);
        ...
        /*
            ...
            일반 for문으로 / 향상된 for
         */
        for (int i = 0; i < modfiedStrList.size() ; i++) {
            System.out.println(modfiedStrList.get(i) + " 언어");
        }
        System.out.println();

        for (String s : modfiedStrList) {
