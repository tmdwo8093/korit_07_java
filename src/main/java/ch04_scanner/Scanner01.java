...
//        name = scanner.nextLine();
        /*
            1. println 과 print의 차이
                ...
                2. nextLine / nextInt / 어쩌고 저쩌고 이런 것들이 있겠다 구분해야겠다.
...
//        System.out.println("이름 : " + name);
        ...
        /*
            ...
            그 경우 다음 nextLine()에서는 enter키를 받아들여서 반값인 상태로 enter를 쳤다고 인지하게 되기 때문에
            곧장 35번 출력문으로 넘어가기 때문입니다.

            해결 방법 : enter 키를 받아주는 nextLine을 만들어줍니다.
         */
