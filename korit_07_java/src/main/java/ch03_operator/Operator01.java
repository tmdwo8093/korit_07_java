...
/*
    ...
    Pascal case -> 첫 번째 문자가 대문자고 나머지는 소문자로 가다가 두 번쨰 단어의 첫 번쨰 문자는 또 대문자
...
public class Operator01 {
    public static void main(String[] args) {
        ...
        // 이전 단계에서 자료형 , 변수형 , 데이터에 대해서 학습했습니다.
        // 이번에는 '='를 배울겁니다.
        i = i + 1;
        /*
            대입 연산자 = : = 왼쪽과 오른쪽이 같다는 의미가 아니라 = 오른쪽에 있는 데이터를
            = 왼쪽에 있는 변수에 '대입' 한다는 의미입니다.
        ...
        // 즉 개발자는 뭐다?
        // 컴퓨터가 잘 작동할 수 있도록 잘 ㅁ여령을 내리는 사람이다, 라고 생각해 주시고
        // 좀 어라고 달래고 해야합니다.
        ...
        System.out.println(j);      // 위의 코드가 실행되고 +1 됐기 때문에 11출력
