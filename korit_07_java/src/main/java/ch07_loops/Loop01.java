...
//        System.out.println("등차수열의 합계 공식 이용 : " + total);
        ...
        /*
            ...
            오히려 비효율적이라는 사실을 이상의 48~49 라인에서 확인 할 수 있습니다.

            하지만 while문 자체는 Java 문법이고 , if에서와 동일하게
            종합적으로 사용이 가능합니다
            그리고 while문 내부에 if문이 들어가는등의 응용도 가능합니다.

            예를 들어, '공차가 2이고 a1이 0인 수열의 a50까지의 합을 구하시오'
            와 같은 문제가 나온다고 가정했을 때, 그떄는 48번 라인의 공식 적용이
            불가능하고, 우리가 공차가 2인 등차수열의 합 공식 같은건 몇년전에 까먹었을겁니다
         */
//        int j = 0;
//        int sum2 = 0;
//        // 정석 버전
