...
public class Main {
    public static void main(String[] args) {
        ...
        int cast4 = 99;         // 얘는 # 1으로,
        int cast5 = 100;        // 얘는 # 2로
        // 지시 사항 : 다운캐스팅 하는 방법을 업캐스팅 방법 #1, 2를 창조하여 char 형으로 바꾼 후
        // 콘솔 창에 원형과 변형을 입력하시오
...
//      char casted5 = cast5;
        /*
            ...
            (아까 강남스타일을 예시로 들었을 때 30억넘는 수치는 다시 int로 형변환하게 되면 마이너스값이 나오게 되는것처럼)
            용량 오버에 해당하는 현상을 미리 점검하기위해 다운캐스팅시에는 일시적(explicit)으로만 변형이 가능합니다

            -> 현재는 기본 자료형을 기준으로 예시를 들었지만 나중에는 창조자료형 캐스팅 개념과 연결됩니다.
            아마도 14번챕터
         */
        ...
        /*
            int가 21의 정도까지의 범위인데 더 큰 숫자로 표기하기 위해서는
