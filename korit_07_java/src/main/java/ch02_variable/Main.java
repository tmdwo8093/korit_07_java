...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
        ...
        하지만 주석 처리를 한 부분에 대해서는 컴퓨터가 코드로 인지하지 않기 떄문에
        오류가 발생하지 않습니다.

        즉 주석이란 컴푸터가 읽어서 처리하는 부분이 아니라 사람이 읽어서 정보를
        얻을 수 있는 데에 의의가 있습니다

        1) 한 줄 주석 : //
        2) 다중 주석 : / + shift + 8 + enter
        3) 사후 주 석 : 주석 처리할 부분의 코드 라인에 ctrl + /
 */
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 백승재입니다.");
//        System.out.println(안녕하세요, 제 이름은 백승재입니다);  // 오류 발생
        ...
        /*
            ...
            하드 코딩이라는 표현을 씁니다.
            하드 코딩 : 명령문에 데이터(변수에 대입되지 않은 데이터인데 이를 리터널
        ...
        String introduction = "안녕하세요 저는 이번 국비 과정을 이수하게 된 백승재입니다";
        System.out.println(introduction + ". 앞으로 잘 부탁 드립니다.");

        /*
            Java 에서의 변수 멍령 규칙 :
                1. 카멜 표기법(camel case) 사용
                    : 첫 문자는 소문자로 시작 / 복수의 단어로 이루어졌을경우
        ...
        // 변수 - 값이 바뀔 수 있음.
        scoreEnglish = 90;                      // 재대입 할떄는 자료형 명시 x
        System.out.println(scoreEnglish);

        // 자료형 수업
        // 1. 논리 자료형(boolean) 변수 : 참 / 거짓 (true/false)
        // 자료형 변수형 = 데이터(값);            변수의 선언 및 초기화
        ...
        char name2 = '승';
        char name3 = '재';
        System.out.println(name1 + name2 + name3); // 결과값 : 149142
        System.out.println('백' + '승' + '재');    // 결과값 : 149142

        System.out.println("" + name1 + name2 + name3); // 결과값 : 백승재
        ...
        /*
            ...
            때문에 원하는 방식으로 출력되지 않습니다. 149 어쩌고로 출력됨

            그렇기 떄문에 70번 라인에서 sout()의 () 내부에 ""를 넣어주니까,
            원하는 결과값을 얻을 수 있었ㅅ브니다.
        ...
        System.out.println("원의 넓이 : " + pi * 43 * 43);
        ...
        // 변수 선언
        String name10 = "백승재";
        String major10 = "기계공학과";
        String mbti10 = "ENTP";
        int age10 = 22;

        /*
            제가 위에 선언한 변수들에 여러분에게 적합한 데이터로 '초기화' 하여
            '저는 코리아 IT 아카데미 7월 국비과정을 수강하고 있는 누구누구입니다. ?? 살입니다. -> 줄바꿈
            제 전공은 어쩌고저쩌고 이며, mbti는 블라블라 입니다. 열심히 할게요 !!!'
            와 같이 출력될수 있도록
         */
        // sout 두번 써서 하는 방법

        System.out.println("저는 코리아 IT 아카데미 7월 국비과정을 수강하고있는 " + name10 + "입니다. " + age10 + "살입니다. ");
        System.out.println("제 전공은 " + major10 + "이며, MBTI는 " + mbti10 + "입니다. 열심히 할게요 !!!");

        //ch03_operator 패키지 생성 ->  Operator01 클래스 생성 -> main 도 적용
    }
}
